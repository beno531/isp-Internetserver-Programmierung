...
<ul class="contact-list">
    ...
    for ($id = 0; $id <= count($contacts) - 1; $id++) {
        echo "<div>" . "<li onclick='loadView(\"contact_details.php\",\"number=$id\")'>" . $contacts[$id]->nachname . ", " . $contacts[$id]->vorname . "</li>" . "<button class='edit-button' onclick='loadView(\"contact_form.php\", \"id=$id\")'>Ändern</button>" . "</div>";
    }
